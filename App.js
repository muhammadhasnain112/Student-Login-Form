...
add.addEventListener("click", function () {
  first.innerHTML = `
        ...
        <button id="second" class="btn1 mt-3">Add Student</button>
        <button id="clear" class="btn1 mt-3">Delete All Data</button>
        <button id="checkStudent" class="btn1  mt-3 ">Check Student</button>
        <br><br>
...
mob.addEventListener('change', () => {
    if (pkNumberRegex.test(mob.value)) {
      mob.style.border = `3px solid green`
    } else {
